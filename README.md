...
Services: DNS, DHCP, HTTP in LAN Environment
Addressing: IP Classes, Subnetting, NAT
Hardware: Physical Router & Switch Configuration


👩‍💻 About
Created as part of the Computer Networks course at Fatima Jinnah Women University (FJWU), Rawalpindi. All labs are designed with step-by-step instructions for Cisco Packet Tracer simulations.
